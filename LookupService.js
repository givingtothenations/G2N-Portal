...
/**
 * Checks if today falls within an active event period in LU_EventInfo.
 * Public wrapper called by ApplicantIntake.html on page load (google.script.run).
 * v4.3 - Originally delegated to getEventInfoForDate(); accidentally removed
 *         during debug cleanup. Restored in v5.3.
...
function getEventInfo() {
    ...
    var timeStr = Utilities.formatDate(now, CONFIG.TIMEZONE, 'HH:mm');
    return getEventInfoForDate(dateStr, timeStr);
}
